...
tbpredictnaive <- data.frame(datatest,risk_naive)
head(tbpredictnaive)

###evaluating prediction
naiveeval<- confusionMatrix(data=risk_naive, reference=datatest$risk_rating)
naiveeval
...
tbpredictsvm <- data.frame(datatest,predictsvm)
head(tbpredictsvm)
...
tbpredictrf <- data.frame(datatest,predictrf)
head(tbpredictrf)
...
tbpredictrf <- data.frame(datatest,predictknn)
head(tbpredictrf)
